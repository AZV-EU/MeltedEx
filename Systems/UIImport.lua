...
function module.Import(TARGET)
	local obj_1, obj_2, obj_3, obj_4, obj_5, obj_6, obj_7, obj_8, obj_9, obj_10, obj_11, obj_12, obj_13, obj_14, obj_15, obj_16, obj_17, obj_18, obj_19, obj_20, obj_21, obj_22, obj_23, obj_24, obj_25, obj_26, obj_27, obj_28, obj_29, obj_30, obj_31, obj_32, obj_33, obj_34, obj_35, obj_36, obj_37, obj_38, obj_39, obj_40, obj_41, obj_42
	...
	obj_34 = Instance.new("Frame")
	obj_34.BorderSizePixel = 0
	obj_34.BackgroundColor3 = Color3.new(0.156863, 0.156863, 0.156863)
	obj_34.AnchorPoint = Vector2.new(0.5, 0.5)
	obj_34.Size = UDim2.new(0, 700, 0, 500)
	obj_34.BorderColor3 = Color3.new(0, 0, 0)
	obj_34.Visible = false
	obj_34.Parent = TARGET
	obj_34.Position = UDim2.new(0.5, 0, 0.5, 0)
	obj_34.Name = "ModalWindow"
	obj_35 = Instance.new("TextLabel")
	obj_35.TextWrapped = true
	obj_35.BorderSizePixel = 0
	obj_35.Name = "TitleBar"
	obj_35.BackgroundColor3 = Color3.new(0.27451, 0.27451, 0.27451)
	obj_35.FontFace = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
	obj_35.TextXAlignment = Enum.TextXAlignment.Left
	obj_35.Parent = obj_34
	obj_35.TextColor3 = Color3.new(1, 1, 1)
	obj_35.Size = UDim2.new(1, 0, 0, 30)
	obj_35.BorderColor3 = Color3.new(0, 0, 0)
	obj_35.Text = "  MeltedEx v1.0"
	obj_35.TextSize = 20
	obj_36 = Instance.new("TextButton")
	obj_36.BorderSizePixel = 0
	obj_36.BackgroundColor3 = Color3.new(0.27451, 0.27451, 0.27451)
	obj_36.FontFace = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
	obj_36.Parent = obj_35
	obj_36.TextColor3 = Color3.new(1, 1, 1)
	obj_36.TextSize = 20
	obj_36.Size = UDim2.new(0, 40, 1, 0)
	obj_36.BorderColor3 = Color3.new(0, 0, 0)
	obj_36.Text = "x"
	obj_36.Position = UDim2.new(1, -40, 0, 0)
	obj_36.Name = "CloseButton"
	obj_37 = Instance.new("ScrollingFrame")
	obj_37.Active = true
	obj_37.BorderSizePixel = 0
	obj_37.CanvasSize = UDim2.new(0, 0, 0, 0)
	obj_37.BackgroundColor3 = Color3.new(1, 1, 1)
	obj_37.AutomaticCanvasSize = Enum.AutomaticSize.Y
	obj_37.Size = UDim2.new(1, 0, 1, -60)
	obj_37.ScrollBarImageColor3 = Color3.new(0, 0, 0)
	obj_37.Name = "Content"
	obj_37.Parent = obj_34
	obj_37.BorderColor3 = Color3.new(0, 0, 0)
	obj_37.BackgroundTransparency = 1
	obj_37.Position = UDim2.new(0, 0, 0, 60)
	obj_38 = Instance.new("UIGridLayout")
	obj_38.Parent = obj_37
	obj_38.CellSize = UDim2.new(0, 135, 0, 155)
	obj_38.SortOrder = Enum.SortOrder.LayoutOrder
	obj_39 = Instance.new("TextButton")
	obj_39.TextWrapped = true
	obj_39.BorderSizePixel = 0
	obj_39.BackgroundColor3 = Color3.new(0.156863, 0.156863, 0.156863)
	obj_39.FontFace = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
	obj_39.Parent = obj_37
	obj_39.TextColor3 = Color3.new(1, 1, 1)
	obj_39.TextSize = 16
	obj_39.Size = UDim2.new(0, 200, 0, 50)
	obj_39.BorderColor3 = Color3.new(0, 0, 0)
	obj_39.Text = ""
	obj_40 = Instance.new("ImageLabel")
	obj_40.BorderSizePixel = 0
	obj_40.ScaleType = Enum.ScaleType.Crop
	obj_40.BackgroundColor3 = Color3.new(1, 1, 1)
	obj_40.Parent = obj_39
	obj_40.Visible = false
	obj_40.Size = UDim2.new(1, 0, 1, -40)
	obj_40.BorderColor3 = Color3.new(0, 0, 0)
	obj_40.BackgroundTransparency = 1
	obj_41 = Instance.new("TextLabel")
	obj_41.TextTruncate = Enum.TextTruncate.AtEnd
	obj_41.BorderSizePixel = 0
	obj_41.BackgroundColor3 = Color3.new(1, 1, 1)
	obj_41.FontFace = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
	obj_41.Parent = obj_39
	obj_41.Visible = false
	obj_41.TextColor3 = Color3.new(1, 1, 1)
	obj_41.Size = UDim2.new(1, 0, 0, 40)
	obj_41.BorderColor3 = Color3.new(0, 0, 0)
	obj_41.Text = ""
	obj_41.TextSize = 16
	obj_41.BackgroundTransparency = 1
	obj_41.Position = UDim2.new(0, 0, 1, -40)
	obj_42 = Instance.new("TextBox")
	obj_42.BorderSizePixel = 0
	obj_42.TextXAlignment = Enum.TextXAlignment.Left
	obj_42.BackgroundColor3 = Color3.new(0.156863, 0.156863, 0.156863)
	obj_42.FontFace = Font.new("rbxasset://fonts/families/Roboto.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
	obj_42.TextColor3 = Color3.new(1, 1, 1)
	obj_42.BorderMode = Enum.BorderMode.Inset
	obj_42.Parent = obj_34
	obj_42.TextSize = 16
	obj_42.CursorPosition = -1
	obj_42.Size = UDim2.new(1, -5, 0, 30)
	obj_42.PlaceholderText = "Filter"
	obj_42.BorderColor3 = Color3.new(0, 0, 0)
	obj_42.Text = ""
	obj_42.Name = "FilterBox"
	obj_42.BackgroundTransparency = 1
	obj_42.Position = UDim2.new(0, 5, 0, 30)
	obj_42.ClearTextOnFocus = true
end
